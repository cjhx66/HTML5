{src: "img/13-bg5-zi.png"}, {src: "img/14-hs.png"}, {src: "img/14-bd.png"}, {src: "img/14-zi1.png"}, {src: "img/45.jpg"}, {src: "img/46.jpg"}, {src: "img/47.jpg"}, {src: "img/48.jpg"}, {src: "img/49.jpg"}, {src: "img/50.jpg"}, {src: "img/51.jpg"}, {src: "img/52.jpg"}, {src: "img/15-bg.jpg"}, {src: "img/15-hd-left.png"}, {src: "img/15-hd-right.png"}, {src: "img/15-zi1.png"}, {src: "img/15-zi2.png"}, {src: "img/15-zi3.png"}, {src: "img/15-jz.png"}, {src: "img/16-jz.png"}, {src: "img/16-tz.png"}, {src: "img/17-zi.png"}, {src: "img/17-zi4-1.png"}, {src: "img/17-zi6.png"}, {src: "img/17-zi-7.png"}, {src: "img/18-zi1.png"}, {src: "img/18-zi2.png"}, {src: "img/18-zi3.png"}, {src: "img/moye.jpg"}, {src: "img/laidianhua.png"}, {src: "img/fenxiang.png"}, {src: "img/20.jpg"}]
    }
    ...
    function init() {
        ...
        page['animate' + 4].to(".tan-h3", 2.5, {marginLeft: -615}, '-=3.4');
        page['animate' + 4].to(".tan-h4", 2.5, {marginLeft: -690}, '-=3.2');
        page['animate' + 4].to(".page4", .5, {
            onStart: function () {
                page['animate' + 4].to(".emperor-js-name", .5, {opacity: 0});
        ...
        page['animate' + 8].to('.title2-8', 2.1, {height: 744, ease: Linear.easeIn});
        page['animate' + 8].to('.title1-8', 2.6, {height: 744, ease: Linear.easeIn});
        ...
        page['animate' + 10].to(".p10-zi1", .5, {opacity: 1, scale: 1}, '-=.5');
        page['animate' + 10].to(".p10-zi1", .5, {delay: .3, rotation: 90, left: -70});
        page['animate' + 10].to(".p10-zi2", .5, {opacity: 1, scale: 1}, '-=.5');
        page['animate' + 10].to(".p10-2", .3, {delay: .1, opacity: 1});
        page['animate' + 10].to(".p10-bg-3", .3, {scale: 1}, '-=.3');
        page['animate' + 10].to(".p10-bg-4", .5, {opacity: 1});
        page['animate' + 10].to(".p10-bg-4", .3, {opacity: 0});
        page['animate' + 10].to(".p10-3", .3, {opacity: 1});
        page['animate' + 10].to(".p10-zi3", .5, {delay: .1, opacity: 1, scale: 1}, '-=.5');
        ...
        page['animate' + 11].to(".p11-ma", .5, {top: 14, rotationX: 0});
        page['animate' + 11].to(".p11-zi5", .5, {delay: .1, opacity: 1, scale: 1});
        page['animate' + 11].to(".xian", .5, {delay: .1, opacity: 1, top: 0, ease: Power4.easeOut});
        page['animate' + 11].to(".ma", .5, {scale: 0});
        page['animate' + 11].to(".xian", .5, {opacity: 0, top: -1150}, '-=.5');
        page['animate' + 11].to(".p11-ren", .5, {scale: 1}, '-=.1');
        ...
        page['animate' + 13].to(".p13-zi2", .5, {bottom: 0});
        ...
        page['animate' + 13].to(".p13-zi3", .3, {bottom: 0});
        ...
        page['animate' + 13].to(".p13-zi4", .3, {top: 0});
