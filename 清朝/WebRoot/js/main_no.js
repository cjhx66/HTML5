$(function () {
    ...
    function loadComplete(event) {  TweenMax.to('.top', .5, {
    ...
    function init() {
        ...
        page['animate' + 5].to(".heshen-js-name", .5, {delay: .5, autoAlpha: 1});
        page['animate' + 5].to(".heshen-js-1", .5, {delay: .3, autoAlpha: 1});
        page['animate' + 5].to(".heshen-js-2", .5, {autoAlpha: 1});
        page['animate' + 5].to(".tan-s1", 2.5, {delay: .1, marginLeft: -710});
        page['animate' + 5].to(".tan-s2", 2.5, {marginLeft: -615}, '-=2.3');
        page['animate' + 5].to(".tan-s3", 3.5, {marginLeft: -615}, '-=2.1');
        page['animate' + 5].to(".tan-s4", 2.5, {marginLeft: -690}, '-=3.4');
        ...
        page['animate' + 9].to(".emperor-speak-3", .8, {opacity: 1, left: 13}, '-=1');
        page['animate' + 9].to(".heshen-speak-3", .8, {delay: .5, opacity: 1, right: 17});
        ...
        page['animate' + 12].to(".p12-zi5", .8, {opacity: 1, left: 0, bottom: 0});
        ...
        page['animate' + 16].to(".huang", 5, {left: -640});
        page['animate' + 16].to(".xiao", 5, {left: -640}, '-=5');
        page['animate' + 16].to(".he", 5, {left: -670}, '-=4.5');
        page['animate' + 16].to(".cheng", 5, {left: -640}, '-=4.5');
        page['animate' + 16].to(".shi", 4, {left: -800}, '-=4.8');
        page['animate' + 16].to(".xiang", 4, {left: -880}, '-=5.8');
