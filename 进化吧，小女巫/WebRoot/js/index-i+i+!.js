                ...
                if (this.R > f.left && this.L < f.left + f.width && this.T < f.top + f.height && this.B > f.top) {
                    ...
                    if (f.type != 0) {
                        ...
                        if (gameMonitor.score >= 20 && gameMonitor.score < 50) {
                            ...
                            //gameMonitor.bgSpeed=bgSpeed*1.2;
                            console.log(gameMonitor.bgSpeed);
                            console.log(Food.speed);
                            //Food.speed=bgSpeed*1.2;
...
Food.prototype.move = function (ctx) {
    //console.log(gameMonitor.foodList);
    //if (gameMonitor.time % this.speedUpTime == 0) {
    //    this.speed *= 1.2;
    //}
    this.top += ++this.loop * this.speed;
    //for (var i = 0; i < gameMonitor.foodList.length; i++) {
    //    if (gameMonitor.foodList[i] != null && gameMonitor.foodList.length >= 2 && gameMonitor.foodList[i] != undefined &&gameMonitor.foodList[i+1] != undefined ) {
    //        var a1l = gameMonitor.foodList[i].left;
    //        var a2l = gameMonitor.foodList[i + 1].left;
    //        //console.log(a1l);
    //        //console.log(a2l);
    //        if (a1l == a2l) {
    //            //console.log(gameMonitor.foodList[i].top);
    //            //console.log(gameMonitor.foodList[i + 1].top);
    //            var a1t = gameMonitor.foodList[i].top;
    //            var a2t = gameMonitor.foodList[i + 1].top;
    //            if (Math.abs(a1t - a2t) < 137) {
    //                gameMonitor.foodList[i] = null;
    //            }
    //        }
    //        //console.log(gameMonitor.foodList);
    //    }
