...
function Ship(ctx) {
    ...
    //绘制女巫
    this.paint = function () {
        this.T = this.top + 18.6;
        this.L = this.left +  14.6;
        this.R = this.left + this.width - 14.6;
...
//障碍物类
function Food(type, left, top, id) {
