    ...
    this.eat = function (foodlist) {
        for (var i = foodlist.length - 1; i >= 0; i--) {
            ...
            if (f) {
                ...
                //console.log("女巫的中心x:"+(this.left + this.width / 2));
                //console.log("女巫的中心y:"+(this.top + this.height / 2));
                console.log(zaw+"的中心x:"+(f.left + this.width / 2));
                console.log(zaw+"的中心y:"+(f.top + f.height / 2));
                //console.log("两个距离宽的绝对值:"+Math.abs((this.left + this.width / 2) - (f.left + f.width / 2)));
                //console.log("两个距离高的绝对值:"+Math.abs((this.top + this.height / 2) - (f.top + f.height / 2)));
                //console.log("两矩形宽的一半:"+((this.width + f.width)/2-10));
                //console.log("两矩形高的一半:"+((this.height + f.height)/2-30));

                if(Math.abs((this.left+this.width/2)-(f.left+ f.width/2))<((this.width+ f.width)/2-10)){
                    if(Math.abs((this.top+this.height/2)-(f.top+ f.height/2))<((this.height+ f.height)/2-30)){

                        var a=Math.abs((this.left+this.width/2)-(f.left+ f.width/2))-((this.width+ f.width)/2);
                        var b=Math.abs((this.top+this.height/2)-(f.top+ f.height/2))-((this.height+ f.height)/2);
                        var c=a>b?a:b;
                        console.log("a:"+a);
                        console.log("b:"+b);
                        console.log("c"+c);
                        f.top= f.top+Math.abs(c);
...
function Food(type, left, id) {
    ...
    this.left = left;
    var random = Math.floor(Math.random() * ($(window).height() / 2 - (-10) + 1) + (-10));
    this.top = random;
