...
function scrollBegin3() {
    scroller = new Scroller(function (left, top, zoom) {
            ...
            if (1665 < scrollPro && scrollPro < 3093 - lastHeight + 300) {
                part5Feichuan.y = scrollNum(1665, 3093 - lastHeight + 300, scrollPro, 2357, 2357 - lastHeight-700);
            }
            if (3093 - lastHeight + 200 < scrollPro && scrollPro < 3093 - lastHeight + 200) {
                part5.y = scrollNum(3093 - lastHeight + 200, 3093 - lastHeight +300, scrollPro, (7350 - lastHeight - (3093 - lastHeight)), (7350 - lastHeight - 3093));
            }
            if (scrollPro > 3093 - lastHeight + 300) {
                part6.alpha = 1;
            } else {
                part6.alpha = 0;
            }
