...
function pixiFn() {
    ...
    loader.load(function (loader) {
        ...
        part3.width = 750;
        part3.height = 3093;
        part3Bg1 = createSprite("images/p2/bg3-1.png", {
            x: -85,
            y: 0
        });
        part3Bg2 = createSprite("images/p2/bg3-2.jpg", {
            x: 0,
            y: 1206
        });
        ...
        tisiXia = TweenMax.fromTo(part3Xia, 1, {alpha: 0.6, y: 972}, {alpha: 1, y: 1012}).repeat(-1).yoyo(true);
        ...
        part3.addChild(part3Bg1,part3Bg2, part3Xia, part3Zi5, part3Jiaodai, part3Lu, part3Chuan, part3Zi4, part3Right);
    ...
    scroller = new Scroller(function (left, top, zoom) {
            ...
            if (scrollPro == contentL1 - lastHeight) {
                ...
                if (1790 < scrollPro && scrollPro < contentW1 - lastWidth) {
                    ...
                    part4Dn.x = scrollNum(1790, contentW1 - lastWidth, scrollPro, 1346, contentW1 - lastWidth - 332.5);
                    part4Dn.y = scrollNum(1790, contentW1 - lastWidth, scrollPro, 822, 121 + 276.5);
...
function scrollBegin3() {
    scroller = new Scroller(function (left, top, zoom) {
            ...
            if (1665 < scrollPro && scrollPro < 3093 - lastHeight + 200) {
                part5Feichuan.y = scrollNum(1665, 3093 - lastHeight + 200, scrollPro, 2357, 2357 - lastHeight-700);
            }
            if (3093 - lastHeight + 200 < scrollPro && scrollPro < 3093 - lastHeight + 300) {
                part5.y = scrollNum(3093 - lastHeight + 200, 3093 - lastHeight +300, scrollPro, (7350 - lastHeight - (3093 - lastHeight)), (7350 - lastHeight - 3093));
            }
            ...
            if (2300 < scrollPro && scrollPro < 2400) {
                part6Title.alpha = scrollNum(2300, 2400, scrollPro, 0, 1);
                part6Title.x = scrollNum(2300, 2400, scrollPro, 22, 52);
            }
            if (2400 < scrollPro && scrollPro < 2500) {
                part6Zi1.alpha = scrollNum(2400, 2500, scrollPro, 0, 1);
            }
