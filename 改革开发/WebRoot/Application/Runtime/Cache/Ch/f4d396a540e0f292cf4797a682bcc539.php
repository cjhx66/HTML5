...
<div class="info_1">
    <div class="info">
        ...
        <div class="info_box">
            <div class="box">
                    <span>姓名</span>
                    <input type="text" id="name" placeholder="请输入您的姓名" onfocus="if(placeholder=='请输入您的姓名'){placeholder=''}" onkeyup="this.value=this.value.replace(/\s+/g,'')" onblur="if(placeholder==''){placeholder='请输入您的姓名'}"/>
            </div>
            <div class="box">
                    <span>电话</span>
                <input type="text" id="phone" placeholder="请输入您的电话" onfocus="if(placeholder=='请输入您的电话'){placeholder=''}" onkeyup="this.value=this.value.replace(/\s+/g,'')" onblur="if(placeholder==''){placeholder='请输入您的电话'}"/>
            </div>
        </div>
                ...
                function (msg) {
                    if (msg == "ok") {
                        ...
                        $(".guan").click(function () {
                            ...
                            var source = $("#source").val();
                            location.href = "/index.php/Ch/Cms/TianZhou/index/source/" + source + "/" + random;
                        })
                    }
                    if (msg == "chongfu") {
                        $(".tank").show();
