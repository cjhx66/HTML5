...
<div class="da_tel">
    ...
    <div class="middle_box_left">
        <img src="/webpage/chphone/cms/public/images/tel.png">
        <a class="yjbo" href="tel:4008198181,833284"><p class="dong">免费<br>看房</p></a>
    </div>
</div>
<div class="da_info">
    <div class="info">
        <div class="guan-1"><img src="/webpage/chphone/cms/public/images/guan-1.png" class="close" id="guan"></div>
        <div class="info_box">
            <div class="box">
                <span>姓名</span>
...
<div class="da_foot">
    <div class="foot">
        <a href="tel:4008198181,833284" class="yjbo" style="display:block">
            <img src="/webpage/chphone/cms/public/images/tel_2.png" alt="">
            <span>免费咨询 <span style="font-size: 26px;">(转833284)</span></span></a>
...
<script language="javascript" type="text/javascript">
    $(function () {
        ...
        $("#btn").click(function () {
            ...
            $.post('/index.php/Ch/Mcenter/XunHuicbm/baomingadd', {phone: phone, name: name, source: source},
                function (msg) {
                    if (msg == "ok") {
                        $(".tank").show();
                        $(".tan p").html("");
                        ...
                        $(".guan").click(function () {
                            ...
                            var source = $("#source").val();
                            location.href = "/index.php/Ch/Cms/XunHuic/index/source/" + source + "/" + random;
                        })
                    }
                    if (msg == "chongfu") {
                        $(".tank").show();
...
<script>
    ...
    (function () {
        ...
        hm.src = "https://hm.baidu.com/hm.js?04ffbe96ac1a398b281e8a29e465583c";
...
<script type="text/javascript">
    $(function () {
        ...
        if (isAndroid == true) {
            ...
            $(".yjbo").attr("href", "tel:4008198181,833284")
        }
    })
</script>
</html>