...
<div class="da">
    <div class="foot">
        <a href="tel:4008198181,611016" class="yjbo" style="display:block">
                ...
                function (msg) {
                    if (msg == "ok") {
                        ...
                        $(".guan").click(function () {
                            ...
                            var source = $("#source").val();
                            location.href = "/index.php/Ch/Cms/YichenJun/index/source/" + source + "/" + random;
                        })
                    }
                    if (msg == "chongfu") {
                        $(".tank").show();
...
<script>
    ...
    (function () {
        ...
        hm.src = "https://hm.baidu.com/hm.js?bf21a5c15962dc1ca8b4f7fdb2b7f6a3";
...
<script type="text/javascript">
    $(function () {
        ...
        if (isAndroid == true) {
            ...
            $(".yjbo").attr("href", "tel:4008198181,611016")
        }
    })
</script>
</html>