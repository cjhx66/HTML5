...
<form id="pagerForm" action="/index.php/Admin/Mcenter/Source" method="post">
...
<div class="page">
    <div class="pageContent">
        <div class="panelBar">
            <ul class="toolBar">
                <?php if(($lie["canadd"] == 1) OR ($_SESSION['adminuser']['username']== 'developer') OR ($_SESSION['adminuser']['username']== 'admin')): ?><li><a class="add" title="将数据导出为Excel表格" href="/index.php/Admin/Mcenter/Source/excel"> <span>导出Excel</span></a></li><?php endif; ?>
                <?php if(($lie["candel"] == 1) OR ($_SESSION['adminuser']['username']== 'developer') OR ($_SESSION['adminuser']['username']== 'admin')): ?><li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="id" postType="string" href="/index.php/Admin/Mcenter/Source/delete" class="delete"><span>批量删除</span></a></li><?php endif; ?>
            </ul>
        </div>
