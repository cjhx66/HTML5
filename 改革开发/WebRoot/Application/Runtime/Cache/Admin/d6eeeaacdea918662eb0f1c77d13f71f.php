...
<form id="pagerForm" action="/index.php/Admin/Mcenter/ParkYifubm" method="post">
	...
	<input type="text" name="authid" value="<?php echo ($authid); ?>" />   
	<input type="text" name="veri" value="<?php echo ($veri); ?>" />   
	<input type="text" name="lie" value="<?php echo ($lieid); ?>" />
	<input type="text" name="formstatus" value="<?php echo ($formstatus); ?>" />
</form>
<div class="page">
    <div class="pageHeader">
        <form onsubmit="return navTabSearch(this);" action="/index.php/Admin/Mcenter/ParkYifubm/index" method="post">
    ...
    <div class="pageContent">
        <div class="panelBar">
            <ul class="toolBar">
                <?php if(($lie["canadd"] == 1) OR ($_SESSION['adminuser']['username']== 'developer') OR ($_SESSION['adminuser']['username']== 'admin')): ?><li><a class="add" title="将数据导出为Excel表格" href="/index.php/Admin/Mcenter/ParkYifubm/excel"> <span>导出Excel</span></a></li><?php endif; ?>
                <?php if(($lie["candel"] == 1) OR ($_SESSION['adminuser']['username']== 'developer') OR ($_SESSION['adminuser']['username']== 'admin')): ?><li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="id" postType="string" href="/index.php/Admin/Mcenter/ParkYifubm/delete" class="delete"><span>批量删除</span></a></li><?php endif; ?>
            </ul>
        </div>
