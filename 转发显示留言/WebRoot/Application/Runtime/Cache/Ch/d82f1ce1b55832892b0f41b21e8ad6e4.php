...
<div class="da_tel">
    <div class="middle_box">
        ...
        <a class="yjbo" href="tel:4006988610,209#"><p class="dong">来电<br>咨询</p>
    ...
    <div class="middle_box_left">
        ...
        <a class="yjbo" href="tel:4006988610,209#"><p class="dong">免费<br>看房</p></a>
    </div>
</div>
<!--输入框组-->
<div class="da">
    <div class="bottom_box">
        <div class="iner_box">
            <input type="text" class="xm" id="name" placeholder="姓名" onkeyup="this.value=this.value.replace(/\s+/g,'')" onfocus="if(placeholder=='姓名'){placeholder=''}" onblur="if(placeholder==''){placeholder='姓名'}">
            <input type="text" class="dh" id="phone" placeholder="电话" onkeyup="this.value=this.value.replace(/\s+/g,'')" onfocus="if(placeholder=='电话'){placeholder=''}" onblur="if(placeholder==''){placeholder='电话'}">
        </div>
...
<script language="javascript" type="text/javascript">
    $(function () {
        ...
        $("#submit").click(function () {
            ...
            $.post('/index.php/Ch/Mcenter/HuaShengbm/baomingadd', {phone: phone, name: name, source: source},
                function (msg) {
                    if (msg == "ok") {
                        $(".tank").show();
                        $(".tan p").html("");
                        ...
                        $(".guan").click(function () {
                            ...
                            window.location.href = "/index.php/Ch/Cms/HuaSheng/index/source/" + source + "/" + random;
                        })
                    }
                    if (msg == "chongfu") {
                        $(".tank").show();
...
<script>
    ...
    (function () {
        ...
        hm.src = "https://hm.baidu.com/hm.js?ac085f42e585c1d7d3c93f69a4ea8801";
