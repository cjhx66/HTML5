...
<div class="da">
    <div class="bottom_box">
        <div class="iner_box">
            ...
            <input type="text" class="dh" id="phone" placeholder="电话" onfocus="if(placeholder=='电话'){placeholder=''}" onkeyup="this.value=this.value.replace(/\s+/g,'')" onblur="if(placeholder==''){placeholder='电话'}">
        </div>
